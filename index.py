...
def __DEFAULT_PAGE(title, ver, uid, mac): #{
    return """<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"><html><head><meta content="text/html; charset=ISO-8859-1" http-equiv="content-type"><title>""" + title + """</title><link rel="stylesheet" type="text/css" href="web_nn.css"></head><body><div class="mainTables"><table class="mainTables"><tr><td rowspan="5">&nbsp;</td><td colspan="2">""" + title + """</td><td rowspan="5">&nbsp;</td></tr><tr><td colspan=2>&nbsp;</td></tr><tr><td>UID:</td><td><pre>""" + uid + """</pre></td></tr><tr><td>MAC Address:</td><td><pre>""" + mac + """</pre></td></tr><tr><td colspan=2>&nbsp;</td></tr><tr><td class="byline ro" colspan=4><em>""" + ver + """</em></td></tr></table></div></body></html>""";
#}
